...
export const hero2About: HeroProps = {
  ...
  subtitle:
    'BrainStation India Foundation (BSIF) is a registered NGO under the Ministry of Corporate Affairs, India. We exist to empower young entrepreneurs to turn their ideas into ventures that create real social and economic impact. We also aim to help underprivileged students fulfil their dreams by supporting their educational needs. Our belief is simple: the untapped potential of smaller cities holds the power to shape India’s future.',
  tagline: '',
  // callToAction: {
  //   text: 'View jobs',
...
export const featuresVisionAbout: FeaturesProps = {
  id: 'features-four-on-about',
  hasBackground: false,
  header: {
    title: 'Vision',
